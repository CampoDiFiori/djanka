...
lazy_static::lazy_static! {
    /// to not have to carry `Writer` everywhere we want to print
    /// it needs `lazy_static!`, because we're using some function calls and dereferencing raw pointers
    /// which don't play well with `static`
